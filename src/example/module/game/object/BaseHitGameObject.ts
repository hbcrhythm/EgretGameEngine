...
class BaseHitGameObject extends BaseAIGameObject {
    ...
    public fly(attackObj:BaseGameObject, speedZ:number, speedX:number):void {
        if (this.onAttack()) {
            ...
            this.lifeBar.scaleX = attackObj.isMyFront(this) ? -attackObj.scaleX : attackObj.scaleX;
            this.roleName.scaleX = attackObj.isMyFront(this) ? -attackObj.scaleX : attackObj.scaleX;
